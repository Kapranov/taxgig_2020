...
```
iex> current_user = Core.Repo.get_by(Core.Accounts.User, email: "client2@gmail.com")
iex> params = %{
  client_name: "Taxgig",
  country_codes: ["US"],
...
iex> params = %{access_token: data["access_token"], start_date: "2020-01-01", end_date: "2021-01-01", options: %{count: 500, offset: 100}}
