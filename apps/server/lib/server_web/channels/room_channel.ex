defmodule ServerWeb.RoomChannel do
  ...
  def handle_in("update", _payload, _socket) do
  end

  def handle_in("delete", _payload, _socket) do
  end
...
# {:ok, data} = PhoenixClient.Channel.push(channel, "index", nil)
...
# {:ok, data} = PhoenixClient.Channel.push(channel, "update", %{"id" => "9vsgUj0rX2aH8Iosgi"})
