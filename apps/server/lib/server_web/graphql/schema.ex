defmodule ServerWeb.GraphQL.Schema do
  ...
  query do
    ...
    import_fields(:deleted_user_queries)
    ...
    import_fields(:pro_rating_queries)
  ...
  mutation do
    ...
    import_fields(:deleted_user_mutations)
    ...
    import_fields(:pro_rating_mutations)
    ...
    import_fields(:service_review_mutations)
    ...
    import_fields(:update_deleted_user_params)
    ...
    import_fields(:update_service_review_params)
