defmodule ServerWeb.GraphQL.Integration.Products.IndividualEmploymentStatusIntegrationTest do
  ...
  describe "#index" do
    ...
    it "returns IndividualEmploymentStatus by role's Pro" do
  ...
  describe "#show" do
    it "returns specific IndividualEmploymentStatus by role's Tp" do
      ...
      query = """
      {
        showIndividualEmploymentStatus(id: \"#{struct.id}\") {
          id
          name
          price
          individual_tax_returns {
  ...
  describe "#find" do
    it "returns specific IndividualEmploymentStatus by role's Tp" do
      ...
      query = """
      {
        findIndividualEmploymentStatus(id: \"#{struct.id}\") {
          id
          name
          price
          individual_tax_returns {
  ...
  describe "#update" do
    it "updated specific IndividualEmploymentStatus by role's Tp" do
      user = insert(:tp_user)
      individual_tax_return = insert(:tp_individual_tax_return, %{user: user})
      struct = insert(:tp_individual_employment_status, %{name: "employed", individual_tax_returns: individual_tax_return})
    ...
    it "updated specific IndividualEmploymentStatus by role's Pro" do
      user = insert(:pro_user)
      individual_tax_return = insert(:pro_individual_tax_return, %{user: user})
      struct = insert(:pro_individual_employment_status, %{name: "employed", individual_tax_returns: individual_tax_return})
  ...
  describe "#delete" do
    it "delete specific IndividualEmploymentStatus" do
      ...
      struct = insert(:individual_employment_status, %{individual_tax_returns: individual_tax_return})

      mutation = """
      {
        deleteIndividualEmploymentStatus(id: \"#{struct.id}\") {id}
      }
      """
  ...
  describe "#dataloads" do
    it "created IndividualEmploymentStatus" do
      user = insert(:user)
      individual_tax_return = insert(:individual_tax_return, %{user: user})
      %{id: id} = insert(:individual_employment_status, %{individual_tax_returns: individual_tax_return})
      ...
      loader =
        ...
        |> Dataloader.load(:individual_employment_statuses, Core.Services.IndividualEmploymentStatus, id)
        |> Dataloader.run

      data = Dataloader.get(loader, :individual_employment_statuses, Core.Services.IndividualEmploymentStatus, id)
