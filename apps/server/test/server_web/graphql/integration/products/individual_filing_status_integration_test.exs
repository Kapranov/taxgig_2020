defmodule ServerWeb.GraphQL.Integration.Products.IndividualFilingStatusIntegrationTest do
  ...
  describe "#index" do
    ...
    it "returns IndividualFilingStatus by role's Pro" do
  ...
  describe "#show" do
    it "returns specific IndividualFilingStatus by role's Tp" do
      ...
      query = """
      {
        showIndividualFilingStatus(id: \"#{struct.id}\") {
          id
          name
          price
          individual_tax_returns {
  ...
  describe "#find" do
    it "returns specific IndividualFilingStatus by role's Tp" do
      ...
      query = """
      {
        findIndividualFilingStatus(id: \"#{struct.id}\") {
          id
          name
          price
          individual_tax_returns {
  ...
  describe "#update" do
    it "updated specific IndividualFilingStatus by role's Tp" do
      user = insert(:tp_user)
      individual_tax_return = insert(:tp_individual_tax_return, %{user: user})
      struct = insert(:tp_individual_filing_status, %{name: "Head of Household", individual_tax_returns: individual_tax_return})
    ...
    it "updated specific IndividualEmploymentStatus by role's Pro" do
      user = insert(:pro_user)
      individual_tax_return = insert(:pro_individual_tax_return, %{user: user})
      struct = insert(:pro_individual_filing_status, %{name: "Head of Household", individual_tax_returns: individual_tax_return})
  ...
  describe "#delete" do
    it "delete specific IndividualFilingStatus" do
      ...
      struct = insert(:individual_filing_status, %{individual_tax_returns: individual_tax_return})

      mutation = """
      {
        deleteIndividualFilingStatus(id: \"#{struct.id}\") {id}
      }
      """
  ...
  describe "#dataloads" do
    it "created IndividualFilingStatus" do
      user = insert(:user)
      individual_tax_return = insert(:individual_tax_return, %{user: user})
      %{id: id} = insert(:individual_filing_status, %{individual_tax_returns: individual_tax_return})
      ...
      loader =
        ...
        |> Dataloader.load(:individual_filing_statuses, Core.Services.IndividualFilingStatus, id)
        |> Dataloader.run

      data = Dataloader.get(loader, :individual_filing_statuses, Core.Services.IndividualFilingStatus, id)
