defmodule ServerWeb.GraphQL.Resolvers.Products.IndividualStockTransactionCountsResolverTest do
  ...
  describe "#index" do
    ...
    it "returns IndividualStockTransactionCounts via role's Pro" do
  ...
  describe "#show" do
    ...
    it "returns specific IndividualStockTransactionCount by id via role's Pro" do
      user = insert(:pro_user)
      individual_tax_return = insert(:pro_individual_tax_return, user: user)
      individual_stock_transaction_count = insert(:pro_individual_stock_transaction_count, %{individual_tax_returns: individual_tax_return})
      context = %{context: %{current_user: user}}
  ...
  describe "#find" do
    ...
    it "find specific IndividualStockTransactionCount by id via role's Pro" do
      user = insert(:pro_user)
      individual_tax_return = insert(:pro_individual_tax_return, user: user)
      individual_stock_transaction_count = insert(:pro_individual_stock_transaction_count, %{individual_tax_returns: individual_tax_return})
      context = %{context: %{current_user: user}}
  ...
  describe "#update" do
    ...
    it "update specific IndividualStockTransactionCountsResolver by id via role's Pro" do
      user = insert(:pro_user)
    ...
    it "nothing change for missing params via role's Tp" do
      user = insert(:tp_user)
      individual_tax_return = insert(:tp_individual_tax_return, user: user)
      individual_stock_transaction_count = insert(:individual_stock_transaction_count, individual_tax_returns: individual_tax_return, name: "some name")
      context = %{context: %{current_user: user}}
      ...
      assert updated.individual_tax_return_id == individual_tax_return.id
      assert updated.inserted_at              == individual_stock_transaction_count.inserted_at
      assert updated.name                     == individual_stock_transaction_count.name
      assert updated.updated_at               == individual_stock_transaction_count.updated_at
    end
    ...
    it "returns error for missing params" do
      ...
      insert(:individual_stock_transaction_count, individual_tax_returns: individual_tax_return)
      context = %{context: %{current_user: user}}
      args = %{id: nil, individual_stock_transaction_count: nil}
