defmodule ServerWeb.GraphQL.Resolvers.Products.BusinessForeignOwnershipCountsResolverTest do
  ...
  describe "#index" do
    ...
    it "returns BusinessForeignOwnershipCounts via role's Pro" do
  ...
  describe "#show" do
    ...
    it "returns specific BusinessForeignOwnershipCount by id via role's Pro" do
      user = insert(:pro_user)
      business_tax_return = insert(:pro_business_tax_return, user: user)
      business_foreign_ownership_count = insert(:pro_business_foreign_ownership_count, %{business_tax_returns: business_tax_return})
      context = %{context: %{current_user: user}}
  ...
  describe "#find" do
    ...
    it "find specific BusinessForeignOwnershipCount by id via role's Pro" do
      user = insert(:pro_user)
      business_tax_return = insert(:pro_business_tax_return, user: user)
      business_foreign_ownership_count = insert(:pro_business_foreign_ownership_count, %{business_tax_returns: business_tax_return})
      context = %{context: %{current_user: user}}
  ...
  describe "#update" do
    ...
    it "update specific BusinessForeignOwnershipCountsResolver by id via role's Pro" do
      user = insert(:pro_user)
    ...
    it "nothing change for missing params via role's Tp" do
      user = insert(:tp_user)
      business_tax_return = insert(:tp_business_tax_return, user: user)
      business_foreign_ownership_count = insert(:tp_business_foreign_ownership_count, business_tax_returns: business_tax_return, name: "some name")
      context = %{context: %{current_user: user}}
      ...
      assert updated.business_tax_return_id == business_tax_return.id
      assert updated.inserted_at            == business_foreign_ownership_count.inserted_at
      assert updated.name                   == business_foreign_ownership_count.name
      assert updated.updated_at             == business_foreign_ownership_count.updated_at
    end
    ...
    it "nothing change for missing params via role's Pro" do
      user = insert(:pro_user)
      business_tax_return = insert(:pro_business_tax_return, user: user)
      business_foreign_ownership_count = insert(:pro_business_foreign_ownership_count, business_tax_returns: business_tax_return, name: "some name")
      context = %{context: %{current_user: user}}
      params = %{name: "some name"}
      args = %{id: business_foreign_ownership_count.id, business_foreign_ownership_count: params}
      {:ok, updated} = BusinessForeignOwnershipCountsResolver.update(nil, args, context)
    ...
    it "returns error for missing params" do
      user = insert(:user)
      business_tax_return = insert(:business_tax_return, user: user)
      insert(:business_foreign_ownership_count, business_tax_returns: business_tax_return, name: "some name")
      context = %{context: %{current_user: user}}
      args = %{id: nil, business_foreign_ownership_count: nil}
  ...
  describe "#delete" do
    it "delete specific BusinessForeignOwnershipCount by id" do
      user = insert(:user)
      business_tax_return = insert(:business_tax_return, user: user)
      struct = insert(:business_foreign_ownership_count, business_tax_returns: business_tax_return, name: "some name")
      context = %{context: %{current_user: user}}
