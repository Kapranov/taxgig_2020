defmodule ServerWeb.GraphQL.Resolvers.Products.BusinessForeignAccountCountsResolverTest do
  ...
  describe "#index" do
    ...
    it "returns BusinessForeignAccountCounts via role's Pro" do
  ...
  describe "#show" do
    ...
    it "returns specific BusinessForeignAccountCount by id via role's Pro" do
      user = insert(:pro_user)
      business_tax_return = insert(:pro_business_tax_return, user: user)
      business_foreign_account_count = insert(:pro_business_foreign_account_count, %{business_tax_returns: business_tax_return})
      context = %{context: %{current_user: user}}
  ...
  describe "#find" do
    ...
    it "find specific BusinessForeignAccountCount by id via role's Pro" do
      user = insert(:pro_user)
      business_tax_return = insert(:pro_business_tax_return, user: user)
      business_foreign_account_count = insert(:pro_business_foreign_account_count, %{business_tax_returns: business_tax_return})
      context = %{context: %{current_user: user}}
  ...
  describe "#update" do
    ...
    it "update specific BusinessForeignAccountCountsResolver by id via role's Pro" do
      user = insert(:pro_user)
    ...
    it "nothing change for missing params via role's Tp" do
      user = insert(:tp_user)
      business_tax_return = insert(:tp_business_tax_return, user: user)
      business_foreign_account_count = insert(:tp_business_foreign_account_count, business_tax_returns: business_tax_return, name: "some name")
      context = %{context: %{current_user: user}}
      ...
      assert updated.business_tax_return_id == business_tax_return.id
      assert updated.inserted_at            == business_foreign_account_count.inserted_at
      assert updated.name                   == business_foreign_account_count.name
      assert updated.updated_at             == business_foreign_account_count.updated_at
    end
    ...
    it "nothing change for missing params via role's Pro" do
      user = insert(:pro_user)
      business_tax_return = insert(:pro_business_tax_return, user: user)
      business_foreign_account_count = insert(:pro_business_foreign_account_count, business_tax_returns: business_tax_return, name: "some name")
      context = %{context: %{current_user: user}}
      params = %{name: "some name"}
      args = %{id: business_foreign_account_count.id, business_foreign_account_count: params}
      {:ok, updated} = BusinessForeignAccountCountsResolver.update(nil, args, context)
    ...
    it "returns error for missing params" do
      ...
      insert(:business_foreign_account_count, business_tax_returns: business_tax_return)
      context = %{context: %{current_user: user}}
      args = %{id: nil, business_foreign_account_count: nil}
