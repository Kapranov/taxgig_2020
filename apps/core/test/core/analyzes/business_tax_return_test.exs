defmodule Core.Analyzes.BusinessTaxReturnTest do
  ...
  describe "#check_match" do
    test "check_match_business_entity_type" do
    end

    test "check_match_business_industry" do
    end

    test "check_match_business_number_of_employee" do
    end

    test "check_match_business_total_revenue" do
    end
  end
