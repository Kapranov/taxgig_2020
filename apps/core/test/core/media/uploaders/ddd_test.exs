defmodule Core.Media.Uploaders.DDDTest do
  use Core.DataCase
  ...
  clear_config([S3]) do
    Config.put([S3],
      ...
      public_endpoint: "https://taxgig.nyc3.digitaloceanspaces.com"
    )
  end

  describe "get_file/1" do
    test "it returns path to local folder for files" do
      assert S3.get_file("2000px-Elm_logo.svg.png") == {
        :ok,
        {:url, "https://taxgig.nyc3.digitaloceanspaces.com/my_test_bucket/2000px-Elm_logo.svg.png"}
      }
    end
