defmodule Core.MIME do
  ...
  @spec check_mime_type(binary()) :: String.t()
  defp check_mime_type(<<0x50, 0x4B, 0x3, 0x4, 0x14, 0x0, 0x6, 0x0, 0x8, 0x0, 0x0, 0x0, _::binary>>) do
    "application/xlsx"
  end

  @spec check_mime_type(binary()) :: String.t()
  defp check_mime_type(<<0x50, 0x4B, 0x3, 0x4, 0x14, 0x0, 0x8, 0x8, 0x8, 0x0, 0x76, 0x33, 0x83, 0x58, _::binary>>) do
    "application/xlsx"
  end

  @spec check_mime_type(binary()) :: String.t()
  defp check_mime_type(<<0x50, 0x4B, 0x3, 0x4, 0x14, 0x0, 0x8, 0x8, 0x8, 0x0, 0xC2, 0x36, 0x83, 0x58, _::binary>>) do
    "application/docx"
  end

  @spec check_mime_type(binary()) :: String.t()
  defp check_mime_type(<<0x50, 0x4B, 0x3, 0x4, 0x14, 0x0, 0x8, 0x8, 0x8, 0x0, 0xB6, 0x2B, 0x83, 0x58, _::binary>>) do
    "application/docx"
  end
