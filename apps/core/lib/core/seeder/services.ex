defmodule Core.Seeder.Services do
  ...
  def reset_database! do
    ...
    SQL.query!(Repo, "TRUNCATE book_keeping_additional_needs CASCADE;")
    SQL.query!(Repo, "TRUNCATE book_keeping_annual_revenues CASCADE;")
    SQL.query!(Repo, "TRUNCATE book_keeping_classify_inventories CASCADE;")
    SQL.query!(Repo, "TRUNCATE book_keeping_industries CASCADE;")
    SQL.query!(Repo, "TRUNCATE book_keeping_number_employees CASCADE;")
    SQL.query!(Repo, "TRUNCATE book_keeping_transaction_volumes CASCADE;")
    SQL.query!(Repo, "TRUNCATE book_keeping_type_clients CASCADE;")
    SQL.query!(Repo, "TRUNCATE book_keepings CASCADE;")
    SQL.query!(Repo, "TRUNCATE business_entity_types CASCADE;")
    SQL.query!(Repo, "TRUNCATE business_foreign_account_counts CASCADE;")
    SQL.query!(Repo, "TRUNCATE business_foreign_ownership_counts CASCADE;")
    SQL.query!(Repo, "TRUNCATE business_industries CASCADE;")
    SQL.query!(Repo, "TRUNCATE business_llc_types CASCADE;")
    SQL.query!(Repo, "TRUNCATE business_number_employees CASCADE;")
    SQL.query!(Repo, "TRUNCATE business_tax_returns CASCADE;")
    SQL.query!(Repo, "TRUNCATE business_total_revenues CASCADE;")
    SQL.query!(Repo, "TRUNCATE business_transaction_counts CASCADE;")
    SQL.query!(Repo, "TRUNCATE individual_employment_statuses CASCADE;")
    SQL.query!(Repo, "TRUNCATE individual_filing_statuses CASCADE;")
    SQL.query!(Repo, "TRUNCATE individual_foreign_account_counts CASCADE;")
    SQL.query!(Repo, "TRUNCATE individual_industries CASCADE;")
    SQL.query!(Repo, "TRUNCATE individual_itemized_deductions CASCADE;")
    SQL.query!(Repo, "TRUNCATE individual_stock_transaction_counts CASCADE;")
    SQL.query!(Repo, "TRUNCATE individual_tax_returns CASCADE;")
    SQL.query!(Repo, "TRUNCATE match_value_relates CASCADE;")
    SQL.query!(Repo, "TRUNCATE sale_tax_frequencies CASCADE;")
    SQL.query!(Repo, "TRUNCATE sale_tax_industries CASCADE;")
    SQL.query!(Repo, "TRUNCATE sale_taxes CASCADE;")
  end
