defmodule Core.Services.BookKeepingNumberEmployee do
  @moduledoc """
  Schema for BookKeepingNumberEmployee.
  """
  ...
  @doc """
  Create changeset for BookKeepingNumberEmployee.
  """
  ...
  def changeset(struct, attrs) do
    ...
    |> unique_constraint(:book_keeping, name: :book_keeping_number_employees_book_keeping_id_index, message: "Only one an BookKeeping")
  end
