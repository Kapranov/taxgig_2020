defmodule Core.Services.IndividualFilingStatus do
  @moduledoc """
  Schema for IndividualFilingStatus.
  """
  use Core.Model
  ...
  @doc """
  Create changeset for IndividualFilingStatus.
  """
  ...
  def changeset(struct, attrs) do
    ...
    |> unique_constraint(:individual_tax_return, name: :individual_filing_statuses_individual_tax_return_id_index, message: "Only one an IndividualTaxReturn")
  end
