defmodule Core.Services.BookKeepingIndustry do
  @moduledoc """
  Schema for BookKeepingIndustry.
  """
  ...
  @doc """
  Create changeset for BookKeepingIndustry.
  """
  ...
  def changeset(struct, attrs) do
    ...
    |> unique_constraint(:book_keeping, name: :book_keeping_industries_book_keeping_id_index, message: "Only one an BookKeeping")
  end
