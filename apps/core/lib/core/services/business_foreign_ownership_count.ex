defmodule Core.Services.BusinessForeignOwnershipCount do
  @moduledoc """
  Schema for BusinessForeignOwnershipCount.
  """
  use Core.Model
  ...
  schema "business_foreign_ownership_counts" do
  ...
  @doc """
  Create changeset for BusinessForeignOwnershipCount.
  """
  ...
  def changeset(struct, attrs) do
    ...
    |> unique_constraint(:business_tax_return, name: :business_foreign_ownership_counts_business_tax_return_id_index, message: "Only one an BusinessTaxReturn")
  end
