defmodule Core.Lookup do
  ...
  """
  @spec create_zipcode(map) :: result | error_tuple
  ...
  """
  @spec update_zipcode(map, map) :: result | error_tuple
  ...
  """
  @spec delete_zipcode(map) :: result
  ...
  """
  @spec change_zipcode(map) :: Ecto.Changeset.t()
