defmodule Core.Landing do
  ...
  """
  @spec change_faq(map) :: Ecto.Changeset.t()
  ...
  """
  @spec change_faq_category(map) :: Ecto.Changeset.t()
  ...
  """
  @spec change_press_article(map) :: Ecto.Changeset.t()
  ...
  """
  @spec change_vacancy(map) :: Ecto.Changeset.t()
