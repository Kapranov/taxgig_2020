defmodule Core.Repo.Migrations.CreateBusinessEntityTypes do
  use Ecto.Migration

  def change do
    create table(:business_entity_types, primary_key: false) do
    ...
    create index(:business_entity_types, [:business_tax_return_id])
  end
end
