defmodule Stripy.StripeService.StripePlatformChargeServiceTest do
  ...
  @user_attrs %{
    "user_id" => FlakeId.get,
    "id_from_card" => "card_1032D82eZvKYlo2C8vPJ6A5c"
  }
  ...
  test "create" do
    ...
    assert charge_attrs["id_from_card"]     == @user_attrs["id_from_card"]
    ...
    assert {:ok, data} = StripePlatformChargeService.create(charge_attrs, @user_attrs)
