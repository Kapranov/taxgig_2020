defmodule Stripy.StripeServices.StripePlatformAccountServiceTest do
  ...
  test "create" do
    ...
    assert {:ok, account_attrs} =
             StripePlatformAccountAdapter.to_params(created_account, @user_attrs)
    ...
    assert account_attrs["tos_acceptance"] ==
             MapUtils.keys_to_string(created_account.tos_acceptance)
