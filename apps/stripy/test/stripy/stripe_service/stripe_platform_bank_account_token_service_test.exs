defmodule Stripy.StripeService.StripePlatformBankAccountTokenServiceTest do
  ...
  test "create" do
    ...
    assert bank_account_token_attrs["account_holder_name"] ==
             created_bank_account_token.bank_account.account_holder_name

    assert bank_account_token_attrs["account_holder_type"] ==
             created_bank_account_token.bank_account.account_holder_type

    assert bank_account_token_attrs["bank_name"] ==
             created_bank_account_token.bank_account.bank_name
    ...
    assert bank_account_token_attrs["currency"] ==
             created_bank_account_token.bank_account.currency

    assert bank_account_token_attrs["fingerprint"] ==
             created_bank_account_token.bank_account.fingerprint

    assert bank_account_token_attrs["id_from_bank_account"] ==
             created_bank_account_token.bank_account.id

    assert bank_account_token_attrs["last4"] == created_bank_account_token.bank_account.last4

    assert bank_account_token_attrs["routing_number"] ==
             created_bank_account_token.bank_account.routing_number
    ...
    assert {:ok, bank_account_token} =
             StripePlatformBankAccountTokenService.create(bank_account_token_attrs, @user_attrs)

    assert bank_account_token.account_holder_name ==
             bank_account_token_attrs["account_holder_name"]

    assert bank_account_token.account_holder_type ==
             bank_account_token_attrs["account_holder_type"]
    ...
    assert bank_account_token.id_from_bank_account ==
             bank_account_token_attrs["id_from_bank_account"]
